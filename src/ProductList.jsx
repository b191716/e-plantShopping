...
function ProductList() {
    ...
    const cartCount = cartItems.length; // Cart count based on the number of items in the Redux store

    const plantsArray = [
        // Same plants array from your code
        {
                        category: "Air Purifying Plants",
                         plants: [{
                              name: "Snake Plant",
        ...
        <div>
            <div className="navbar" style={{ backgroundColor: '#4CAF50', color: '#fff', padding: '15px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '20px',width:1535,height:150}}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <span style={{ color: 'white', fontSize: '24px', marginLeft: '10px' }}>{cartCount}</span>
                </div>
            </div>
            {!showCart ? (
                <div className="product-grid">
